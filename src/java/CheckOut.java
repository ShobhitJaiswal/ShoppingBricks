...
HttpSession session=request.getSession(false);
		...
		try {
			...
			stmt1.addBatch("insert into address(emailid,address1,address2,landmark,city,pincode,state,userid,orderid) values('"+emailid+ "','"+address+"','"+ship_address+"','"+landmark+"','"+city+"','"+areacode+"','"+state+"','"+userid+"','"+orderid+"')");

			stmt1.addBatch("insert into shipingadd(emailid,address1,address2,landmark,city,pincode,state,userid,orderid) values('"+emailid+ "','"+address+"','"+ship_address+"','"+landmark+"','"+city+"','"+areacode+"','"+state+"','"+userid+"','"+orderid+"')");
